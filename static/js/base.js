...
async function openDataObjectModal(table) {
  ...
  const config = {
    ...
    warehouse_inventory: { icon: '📦', title: 'Warehouse Medicine Inventory Table', subtitle: 'Table: public.warehouse_inventory | Mapped from Supabase System of Record' },
    drivers: { icon: '👨‍✈️', title: 'Drivers Directory Table', subtitle: 'Table: public.drivers | Mapped from Supabase System of Record' }
  };
